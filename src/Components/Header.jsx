...
const Header = () => {
  ...
  return (
    <>
      <button
        className="fixed z-30 top-4 right-4 sm:top-10 sm:right-10 p-2 text-gray-700 text-xl lg:text-3xl bg-white rounded-full shadow-xl border-gray-100 border-[1px]"
        onClick={() => {
      ...
      >
        ...
        <section>
          ...
          <div className="logo flex items-center gap-4 mb-8">
            ...
            />
            <div>
              <h3 className="font-bold text-purple-900">Samy.front</h3>
          ...
          <ul className="mt-4 mb-8">
            ...
            <li>
              ...
              >
                ...
                <span>Tegnologias</span>
              </a>
            </li>
            <li>
              <a
                href="./#plantillas"
                className="flex items-center gap-4 p-2 hover:bg-gray-200 rounded-lg transition-all duration-900 ease-linear only:"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
          ...
          <hr className="my-8" />
          <div className="w-full gap-4 p-2 flex flex-col justify-center items-center bg-gray-200 h-72">
            <h2 className="text-2xl font-bold text-gray-500 ">En desarrollo</h2>
            <span className="text-sm font-light text-gray-500 text-center">
              Algunas funcionalidades no se encuentran activas ya que están en
          ...
          <div className="flex items-center gap-4 pt-4 border-t">
            ...
            <div>
              <h3 className="font-bold text-gray-900">
                Samuel Abner Santana Montilla
              </h3>
              <p className="text-gray-800 text-xs">Desarrollador Frontend</p>
            </div>
          </div>
        </section>
      </header>
